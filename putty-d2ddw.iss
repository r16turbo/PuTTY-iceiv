...
; binary
Source: "putty-d2ddw-{#VERSION}\putty.exe"; DestDir: "{app}"; Flags: promptifolder replacesameversion restartreplace uninsrestartdelete
...
Source: "putty-d2ddw-{#VERSION}\README"; DestDir: "{app}"; DestName: "README.txt"; Flags: restartreplace uninsrestartdelete
; japanese
