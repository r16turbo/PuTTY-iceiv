...
#define VERSION 20150228

[Setup]
AppId=PuTTY
AppName=PuTTY GDI
AppVersion={#VERSION}
AppVerName=PuTTY GDI
...
; 32bit
Source: "putty-gdi-{#VERSION}\putty.exe"; DestDir: "{app}"; Check: not Is64BitInstallMode; Flags: promptifolder replacesameversion restartreplace uninsrestartdelete
...
; 64bit
Source: "putty-gdi-{#VERSION}\x64\putty.exe"; DestDir: "{app}"; Check: Is64BitInstallMode; Flags: promptifolder replacesameversion restartreplace uninsrestartdelete
...
; source
Source: "putty-gdi-{#VERSION}\patch\gdi.diff"; DestDir: "{app}\patch"; Components: source; Flags: restartreplace uninsrestartdelete
